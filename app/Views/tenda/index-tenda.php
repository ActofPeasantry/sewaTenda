			...
			<div class="card-content collapse show">
				<div class="card-body">
					...
					<form action="/add-edit-tenda-view" method="post">
						...
						<button type="submit" class="btn btn-primary btn-min-width mr-1 mb-1"><i class="ft-plus"></i> Add Item</button>
						<a class="btn btn-info btn-min-width mr-1 mb-1" href="/kategori"><i class="la la-road"></i> Kategori Item</a>
					</form>
							...
							<tbody>
								...
								<?php foreach ($tendaList as $tenda) : ?>
									<tr>
										...
										<!-- <td style = "text-align : center"><img src=<= $tenda['gambar'] ?> alt="Gambar Item" style = "max-width: 100px; height: auto;"></td> -->
										<td style="text-align : center"><img src=<?= site_url('download/' . $tenda['gambar']) ?> alt="Gambar Item" style="max-width: 100px; height: auto;"></td>
										<td style="text-align : center">
											<form action="/add-edit-tenda-view" method="post">
												...
												<a style="color: white; text-decoration: none;" href="tenda/delete/<?= $tenda['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete Data Item <?= $tenda['nama'] ?> (<?= $tenda['kode'] ?>)? ')"><i class="ft-delete"></i></a>
											</form>
										</td>
									</tr>
									<?php $i++ ?>
